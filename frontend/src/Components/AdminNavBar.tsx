...
const NavLink = ({ children, to }: NavLinkProps) => {
  ...
  const inactiveStyle =
    "px-2 py-1 text-gray-600   hover:bg-sky-200 rounded ";
  ...
  return (
    <div className="flex h-14 items-center  bg-secondary">
      <div  className="ml-4 w-44">
            <Link to="/selectMode">
        <svg width="100%" height="100%" viewBox="0 0 370.45454545454544 154">
          <g
            transform="matrix(1.3255982036692617,0,0,1.3255982036692617,-2.647564234430773,35.348803592661476)"
            fill="#000000"
          >
